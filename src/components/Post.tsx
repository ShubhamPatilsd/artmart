...
export const Post: React.FC<PostProps> = ({
  ...
  return (
    <div
      className={
        "group hover:bg-blue-900 hover:bg-opacity-40 hover:border-transparent hover:shadow-lg duration-100 rounded-md border border-gray-300 p-4"
      }
    >
      ...
      <div className="h-30 md:h-36 lg:h-48 rounded-lg flex justify-center">
        <img
          src={coverPhoto}
          className="shadow-lg relative z-10 group-hover:brightness-50 h-full w-auto  rounded-t-lg"
        />
      </div>
      <div>
        <div className="bg-indigo-500 bg-opacity-80 h-auto absolute opacity-0 group-hover:opacity-100 z-50 -mt-24 p-2 rounded-lg  pr-8 w-auto">
